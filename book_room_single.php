...
<div class="container" style="margin-left:125px; margin-right:125px">
  ...
  <div class="w3-container" id="apartment">
    ...
    <h2 class="w3-text-red">RM50/night</h2>
    <div class="w3-display-container mySlides">
    <img src="single1.jpg" style="width:100%;margin-bottom:-6px">
    ...
    <div class="w3-display-container mySlides">
    <img src="single2.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Furniture Provided</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
    <img src="single3.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Bedroom</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
    <img src="single4.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Bathroom</p>
      </div>
    </div>
  ...
  <div class="w3-row-padding w3-section">
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="single1.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(1)" title="Work Station">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="single2.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(2)" title="Furniture Provided">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="single3.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(3)" title="Bedroom">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="single4.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(4)" title="Bathroom">
    </div>
  </div>
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      ...
      <div class="w3-col s6">
       ...
       <input type="hidden" name="item_name" id="item_name" value="Single Room"/>
       <input type="hidden" name="image_src" id="image_src" value="single1.jpg"/>   
    </div>
    <hr>
