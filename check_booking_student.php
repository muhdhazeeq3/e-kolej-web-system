...
//Create 
  try {
    ...
    $stmt = $conn->prepare("SELECT * FROM tbl_booking_room, tbl_kiz_student WHERE tbl_booking_room.fld_student_matric = tbl_kiz_student.student_matricNo");
...
<h2 style="padding-left: 30px; margin-bottom: 10px">Check Booking Status</h2>

<p style="padding-left: 30px">Booker ID:</p>

<form style="padding-left: 30px">
  <input type="text" name="search" placeholder="Your Booking ID" value="<?php echo $matric?>" readonly>
</form>
...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" style="padding: 30px">
      ...
      <table class="table table-striped table-bordered" id="table_check_booking">
        <tr>
          ...
          <th onclick="sortTable(6)">Additional Notes</th>
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_student_matric']; ?></td>
...
<!--         <td style="text-align:center"><?php echo $readrow['complaint_attachment']; ?></td> -->
        ...
        if($readrow["fld_booking_status"]==="DONE"){
        echo "DONE"."<br>";
        }
        ...
        ?></td>
        <td><?php echo $readrow['fld_add_note']; ?></td>
...
function sortTable(n) {
  ...
  table = document.getElementById("table_check_booking");
  switching = true;
